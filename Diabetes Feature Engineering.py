...
# Outcome: Kişinin diyabet olup olmadığı bilgisi. Hastalığa sahip (1) ya da değil (0)
           ...
           # Adım 4: Hedef değişken analizi yapalım. (Kategorik değişkenlere göre hedef değişkenin ortalaması, hedef değişkene göre numerik değişkenlerin ortalaması)
...
# Quantiles değerlerine baktığımız zaman bazı soru işaretleri oluşmakta . Örneğin minimum ve maksimüm insülin değerleri arasında
# büyük bir sıçrama olduğu için aykırı değer varlığını düşünebiliriz yada bir insanın kan basıncı 0 olamayacağı için
# eksik veri yada null değerleri düşünebiliriz
